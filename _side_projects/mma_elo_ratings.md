...
### Peak ELO Ratings
I start by creating a list of the peak ELO ratings achieved by any fighter in Table 1; this rating can be used as one proxy for determining the greatest fighters of all time (GOATs), but capturing sustained success is also an important metric (see below for my GOAT analysis). Anderson Silva achieves the highest peak rating in this model by nearly 28 points over Fedor Emelianenko. Both went on historic runs, but Silva holds on to the top spot after his 10 successful defenses in the UFC middleweight division. Islam Makhachev also cracks the top five peak ratings after his dominant performance over Jack Della Maddalena at UFC 322. 

I speculate that the rise of champion vs champion fights across weight classes, starting in 2016 when Conor McGregor moved up to fight Eddie Alvarez for the lightweight title, has contributed to some rating inflation. Eleven of the top thirty fighters and four of the top six fighters by peak ELO rating have been involved in one of these bouts. Henderson is the only fighter to have earned the "double champ" status from this list prior to 2016 (doing so in Pride in 2007). 
...
### Greatest Fights
I also sum the ELO ratings of fighters and their opponents to create a list of the top fights of all time in Table 3. By Elo rating, the trilogy fight between Daniel Cormier and Stipe Miocic tops the list at numbers 1, 2, and 5 all-time. Cormier is involved in five of the top ten fights on the list, with his 1st fight against Jon Jones and fight against Derrick Lewis coming in at #9 and #10, respectively. Cormier vs Jones 2 does not crack the top 10 as it was ruled a no-contest (omitted from the dataset) after Jones failed a drug test.
...
$$
Legacy  Score = z_{peak ELO} + z_{AUEC} + z_{SoS} + z_{QAW}
$$

Table 4 lists the top ten fighters by Legacy Score alongside their standardized metrics. Fedor, GSP, Jones, and Silva take the top spots, which is highly consistent with most subjective lists where they are typically ranked in the all-time top five. Perhaps most surprising in this list is Lyoto Machida. While he certainly had a great career, challenging for UFC titles in two weight classes and capturing the belt at light heavyweight, he also has the lowest peak ELO rating among this group. Machida's Legacy Score is mainly bolstered by his tough strength of schedule and strong quality-adjusted wins; throughout his career, he faced unusually elite opposition, including 20 bouts against current or former UFC, PRIDE, Bellator, or Strikeforce champions.
